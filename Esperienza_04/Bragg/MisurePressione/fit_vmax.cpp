void fit_vmax()
{
    ...
    nt->ReadFile("fit_vmax_suddivisi.txt");
    nt->Draw("press:er_press:mean1:errmean1:mean2:errmean2:mean3:errmean3", "", "goff");

    TGraphErrors *graph_1 = new TGraphErrors(nt->GetSelectedRows(), nt->GetVal(0), nt->GetVal(2), nt->GetVal(1), nt->GetVal(3));
    TGraphErrors *graph_2 = new TGraphErrors(nt->GetSelectedRows(), nt->GetVal(0), nt->GetVal(4), nt->GetVal(1), nt->GetVal(5));
    TGraphErrors *graph_3 = new TGraphErrors(nt->GetSelectedRows(), nt->GetVal(0), nt->GetVal(6), nt->GetVal(1), nt->GetVal(7));
    ...
    graph_1->GetYaxis()->SetTitle("vmax [a.u.]");
    graph_1->Draw("ap");
    c1->Print("Np-237_vmax.pdf");
    ...
    graph_2->GetYaxis()->SetTitle("vmax [a.u.]");
    graph_2->Draw("ap");
    c2->Print("Am-241_vmax.pdf");
    ...
    graph_3->GetYaxis()->SetTitle("vmax [a.u.]");
    graph_3->Draw("ap");
    c3->Print("Cm-244_vmax.pdf");
