...
void circ_2()
{
    ...
    fileInput->SetTitle("");
    fileInput->GetXaxis()->SetTitle("freq [kHz]");
    fileInput->GetYaxis()->SetTitle("A [V/V]");
    ...
    simul->SetTitle("");
    simul->GetXaxis()->SetTitle("freq [kHz]");
    simul->GetYaxis()->SetTitle("A [V/V]");
